<?php
	...
	class Illness {
		protected static $table_name = "illness";
		protected static $db_fields = array("illness_id","name","parent","category");
		public $illness_id;
		public $name;
		public $parent;
		public $category;
		...
		public function symptoms(){
			return Symptom::find_symptoms_on($this->id);
		}
		...
		public static function find_by_id($id = 0){
			if($id != 0){
				global $database;
				$query = "SELECT * FROM ".self::$table_name." WHERE illness_id = '".$database->escape_value($id)."'";
