<?php require_once('../../includes/initialize.php'); global $session; global $page_title?>
<!DOCTYPE html>
...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
        ...
        <title>Smart Health Prediction System ~ Admin</title>
    ...
    <ul class="ls">
		  ...
		  <li><a class="loginbtn" href="index.php">Home</a></li>
		   <?php if ($session->is_logged_in()) { ?>
			...
			<li><a class="loginbtn" href="notification.php">Notifications</a></li>
			<li><a class="loginbtn" href="add_illness.php">Add Illness</a></li>
